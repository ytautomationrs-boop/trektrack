...
- Build 5 restores the Profile tab with steps today at the top and an expandable entered-race list. Identity editing, posts, games, race history, created competitions, wallet, and settings are together in Profile. The personal daily goal remains removed.
