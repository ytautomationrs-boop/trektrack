...
export function confirmVerifiable(
  ...
  showAlert("This can't be scored here", `ASTA scores from a workout file you export from your watch or training app, and ${reason} Your total would stay at zero.`, [
