    ...
    <View style={styles.screen}>
      <View style={styles.centerBlock}>
        ...
        <Text style={styles.slideBody}>
          {isWeb
            ? "Export the workout from your watch or training app and upload the file — Streak reads .gpx, .tcx and .fit. We never accept typed-in numbers. You can also connect Strava from your profile if you'd rather it came across on its own."
            : "Streak reads your steps and workouts from Health to verify race and challenge results — we never accept typed-in numbers."}
        </Text>
